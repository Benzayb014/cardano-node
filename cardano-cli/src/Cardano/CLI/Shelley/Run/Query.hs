...
import qualified Control.State.Transition.Extended as Transition
...
obtainLedgerEraClassConstraints
  ...
  -> (( UsesValue ledgerera
      ...
      , Share (Core.TxOut ledgerera) ~ Interns (Ledger.Credential 'Staking StandardCrypto)
      , FromSharedCBOR (Core.TxOut (ShelleyLedgerEra era))
      , FromCBOR (Core.PParams (ShelleyLedgerEra era))
      , FromCBOR (Transition.State (Core.EraRule "PPUP" (ShelleyLedgerEra era)))
      ) => a) -> a
